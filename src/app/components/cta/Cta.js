...
export default function Cta () {
    return (
        <>
            <section className="text-white max-w-[1320px] mx-auto py-8 my-[50px] flex justify-between items-center">
                <div>
                ...
                <button className="bg-[#2896df] px-4 py-2 h-12 w-36 font-bold">Download</button>
            </section>
        </>
    )
}