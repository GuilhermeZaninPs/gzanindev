            ...
            <div className="text-white">
              ...
              <div>
                    <div className="w-[15%] flex justify-between mt-[15px]">
                        <a href={'https://www.linkedin.com/in/guilhermezaninps/'} className="w-[35px] h-[35px] bg-black/20 rounded-full flex justify-center items-center">
                            <svg
                        ...
                        <a href={'https://github.com/GuilhermeZaninPs'} className="w-[35px] h-[35px] bg-black/20 rounded-full flex justify-center items-center">
